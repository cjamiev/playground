...
describe.skip('Generator', () => {
  ...
  it('handle Delete', async () => {
    ...
    expect(api.post).toHaveBeenCalledWith('/file', { filename: 'generator.json', content: JSON.stringify([]) });
  });
  ...
  it('handle Save', async () => {
    ...
    expect(api.post).toHaveBeenCalledWith('/file', { filename: 'generator.json', content: JSON.stringify(result) });
  });
