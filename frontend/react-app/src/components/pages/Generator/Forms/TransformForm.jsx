...
const TransformForm = ({ style, onChange }) => {
  ...
  return (
    <>
      ...
      <div className="flex--horizontal">
        <Range id="skewX" label="Skew X" min={SKEW_MIN} max={SKEW_MAX} selected={style.skewX} onChange={onChange} />
        <Range id="skewY" label="Skew Y" min={SKEW_MIN} max={SKEW_MAX} selected={style.skewY} onChange={onChange} />
      </div>
    </>
  );
};
