...
describe.skip('Settings', () => {
  ...
  it('handle save on change link table', () => {
    ...
    expect(api.post).toHaveBeenCalledWith('/db', {
      content: JSON.stringify({
        commands: mockStore.settings.commands,
        links: [
  ...
  it('handle add directory', () => {
    ...
    fireEvent.change(screen.getByLabelText('New Directory text field'), { target: { value: 'dir3' } });
  ...
  it('handle add link', () => {
    ...
    fireEvent.change(screen.getByLabelText('New Link Value text field'), { target: { value: 'linkThree' } });
    fireEvent.change(screen.getByLabelText('New Link Label text field'), { target: { value: 'linkLabelThree' } });
