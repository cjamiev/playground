...
export const EyeSVG = ({ transform, conditions = {} }) => {
  ...
  return (
    <g transform={transform}>
      <g data-testid="component-eye" aria-label="eye" className="icon--hollow" transform="matrix(1.0190416,0,0,1.0190416,-272.32625,-23.701615)" >
        ...
        { showCross && <rect data-testid="cross" className="svg__68 icon--black" aria-label="condition cross" width="3.6276019" height="65.926086" x="181.0412" y="202.23616" transform="rotate(-42.522975)" /> }
      </g>
    </g>
  );
};
