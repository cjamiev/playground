...
const HomeIcon = () => {
  return (
    <g
      ...
      transform="matrix(0.35180651,0,0,0.35180651,-9.3226795,-13.401312)">
      <g
        transform="translate(-0.6494285)">
        <g className="home-icon__roof">
          <path
            d="M 28.72619,111.125 103.94345,62.744048"
          />
          <path
            d="M 175.98569,111.125 100.76843,62.744048"
          />
        </g>
        <path
