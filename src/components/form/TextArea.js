...
const TextArea = ({ id, label, selected, jsonType, fullPage, error, errorMessage, onChange }) => {
  ...
  return (
    <div className="textarea__container">
      <label>{label}</label>
      <textarea className={fullPage ? 'textarea--full-size' : ''} rows="20" cols="100" aria-label="text-area" value={formattedValue} onChange={handleSelectedChange}></textarea>
