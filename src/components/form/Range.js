  ...
  return (
    <div>
      <div className={className}>
        ...
        <input className='input__item-field' type="range" name={label} aria-label={`${label} range field has value ${selected}`} min={min} max={max} value={selected} onChange={handleSelectedChange} />
      </div>
    </div>
  );
};
